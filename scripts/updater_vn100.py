...
def main():
    csv_path = "./dataset/basic_info/companies_vn100.csv"
    if not os.path.exists(csv_path):
        print(f"File {csv_path} does not exist.")
        return

    # Load VN100 companies
    ...
    print(f"Starting data update for {len(symbols)} VN100 symbols...")
